...
// Global Variables
// -------------------------------------------------
int Width = 1280; // set the image width and height
int Height = 720;
std::vector<float> OutputImage; // fill out the pixels of this image in the render() function 
// and we'll display it using glDrawPixels(...) in the main loop
// -------------------------------------------------
...
void render()
{
	...
	for (int j = 0; j < Height; ++j) 
	{
		...
		{
			// For each pixel, we need to set the color for that pixel in the output image.
			 
			
			// ---------------------------------------------------
			// --- Implement your code here to generate desired image
			// ---------------------------------------------------
			
			//-- e.g. draw a red rectangle in the center of the image
